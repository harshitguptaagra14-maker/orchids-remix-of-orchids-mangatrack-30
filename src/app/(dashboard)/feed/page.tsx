      ...
      <div className="p-4 sm:p-6 space-y-6 max-w-2xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">See what your friends are reading</p>
        </div>
        <Link href="/friends">
            ...
            <div key={activity.id} className="space-y-4">
              ...
              {!activity.series && (
                ...
                <div className="flex items-center gap-6 px-2">
                    <button
                      className={`flex items-center gap-1.5 transition-colors touch-target ${activity.liked_by_viewer ? "text-red-500" : "text-zinc-400 hover:text-red-500"}`}
                      onClick={() => handleLike(activity)}
                    >
                      <Heart className={`size-4 ${activity.liked_by_viewer ? "fill-current animate-heart-burst" : ""}`} />
